...
def adicionar_erro(setor: str, ean: str, motivo: str, codigo_mes: str = None, codigo_ano: str = None):
...
def processar_bip_produto(setor: str, codigo: str) -> dict:
    """
...
def cancelar_ultimo_produto(setor: str, ean: str) -> tuple:
    """
